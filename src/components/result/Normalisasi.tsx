...
interface NormalisasiProps {
    data: Perhitungan | null;
}

export default function Normalisasi({ data }: NormalisasiProps) {
    if (!data) return null;

    return (
        <div>
            <h2 className="text-xl font-bold text-foreground mb-4">Data Alternatif (Normalisasi)</h2>
                    ...
                    <tbody>
                        {data.alternatif.map((e, i) => (
                            ...
                            >
                                ...
                                {e.nilaiKriteriaNorm?.map((element, index) => (
            ...
            <h2 className="text-xl font-bold text-foreground mb-4">Data Kriteria (Normalisasi)</h2>
                    ...
                    <tbody>
                        {data.kriteria.map((e, i) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-3">{e.bobotNorm}</td>
